...
public class WeatherApiServiceImpl implements WeatherApiService {
    ...
    public FlightPossibilityResult evaluateFlightPossibility(Integer clientID) {
        ...
        Parameter clientParameters = clientDaoImpl.getParametersByClientId(clientID);
        ...
        CurrentWeather currentWeather = weatherApiClientService.getCurrentWeather(clientParameters.getLocation());
