...
public class TestController {
    ...
    @GetMapping("/current")
    public CurrentWeather getWeather(@RequestParam("city") String city) {
    ...
    @GetMapping("/fly")
    public FlightResponse fly(Parameter parameter) {
        return weatherAPIService.evaluateThePossibilityOfFlight(parameter);
    }
}
